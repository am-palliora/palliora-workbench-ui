...
> [!NOTE]
> This is `am-palliora`'s fork, kept in sync with upstream. To connect
> this UI to [`palliora-adapter`](https://github.com/am-palliora/palliora-adapter),
> see [PALLIORA.md](./PALLIORA.md).
